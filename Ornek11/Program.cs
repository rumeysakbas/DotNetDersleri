namespace Ornek11
{
    internal class Program
    {
        ...
        {
            //Kullanıcıdan 2 tane sayı alınız Kullanıcıya hangi işlemi yapmak istediğini sorunuz (toplama çıkarma) İstenilen işlemi kullanıcının girdiği sayılara uygulayınız
        ...
        islemTurSec:
            ...
            else if (islemTuru != 1 && islemTuru != 2)
            {
                Console.ForegroundColor = ConsoleColor.Red;
